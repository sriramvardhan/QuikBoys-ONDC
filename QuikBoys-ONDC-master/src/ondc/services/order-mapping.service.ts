  ...
  async createOrderFromOndc(
    ...
    const order = await this.prisma.order.create({
      data: {
        ...
        pickupAddress: pickupAddress as Prisma.InputJsonValue,
        pickupLatitude: pickupLat,
        pickupLongitude: pickupLng,
        deliveryAddress: deliveryAddress as Prisma.InputJsonValue,
        deliveryLatitude: deliveryLat,
        deliveryLongitude: deliveryLng,
        items: (confirmOrder.items || []) as unknown as Prisma.InputJsonValue,
        subtotal: 0,
    ...
    this.eventEmitter.emit(
      ...
      new OrderCreatedEvent(order.id, null, 'ONDC'),
    );
