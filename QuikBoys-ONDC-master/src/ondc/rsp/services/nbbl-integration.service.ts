...
export class NBBLIntegrationService {
  ...
  async getSettlementAccount(
    ...
    return {
      ...
      bankAccount: {
        accountNumber: this.maskAccountNumber(user.bankDetails.accountNumber),
        ifscCode: user.bankDetails.ifscCode,
        accountHolderName: user.bankDetails.accountHolderName,
        bankName: user.bankDetails.bankName,
        branchName: user.bankDetails.branchName || undefined,
      },
      isVerified: true, // Assumed verified if bank details exist
      isPrimary: true,
      createdAt: user.bankDetails.createdAt,
      verifiedAt: user.bankDetails.updatedAt,
    };
  }
